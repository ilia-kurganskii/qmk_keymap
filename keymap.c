...
[_QWERTY] = LAYOUT(
    ...
    KC_LSFT,   KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,    KC_MUTE, KC_D_MUTE, KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RSFT,
            KC_LGUI,    KC_LALT,    LT(_SYM,KC_ESC), LT(_NAV,KC_SPC),   KC_TAB,  KC_ENT,    KC_BSPC, LT(_ADJUST,KC_DEL),        KC_RALT, KC_RGUI
),
...
[_SYM] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, _______,       _______, KC_GRV,  KC_RBRC, _______, _______, _______, _______,
                    _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
),
